...
def get_int_input(prompt):
    while True:
        try:
            ...
            print("Sorry, that is an invalid input. Please enter a whole number.")
...
def main():
    ...
    savings_interest = float(input("Enter the APR interest rate for the savings account (as a decimal): "))
    ...
    cd_interest = float(input("Enter the APR interest rate for the CD account (as a decimal): "))
